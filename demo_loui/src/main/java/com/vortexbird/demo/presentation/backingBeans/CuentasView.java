...
public class CuentasView implements Serializable {
    ...
    public void rowEventListener(RowEditEvent e) {
        try {
            ...
            txtCliId.setValue(cuentasDTO.getCliId());
    ...
    public String action_edit(ActionEvent evt) {
        selectedCuentas = (CuentasDTO) (evt.getComponent().getAttributes()
                                           .get("selectedCuentas"));
        txtCliId.setValue(selectedCuentas.getCliId());
        txtCliId.setDisabled(false);
    ...
    public String action_create() {
        try {
            ...
            entity.setCliId(FacesUtils.checkLong(txtCliId));
    ...
    public String action_modifyWitDTO(Long cliId, String cueActiva,
        String cueClave, String cueNumero, Double cueSaldo)
        throws Exception {
        try {
            entity.setCliId(FacesUtils.checkLong(cliId));
