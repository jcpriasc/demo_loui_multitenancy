...
public class ClientesView implements Serializable {
    ...
    public void rowEventListener(RowEditEvent e) {
        try {
            ...
            txtTdocCodigo.setValue(clientesDTO.getTdocCodigo());
    ...
    public String action_edit(ActionEvent evt) {
        ...
        txtCliTelefono.setDisabled(false);
        txtTdocCodigo.setValue(selectedClientes.getTdocCodigo());
        txtTdocCodigo.setDisabled(false);
    ...
    public String action_create() {
        try {
            ...
            entity.setTdocCodigo(FacesUtils.checkLong(txtTdocCodigo));
    ...
    public String action_modifyWitDTO(String cliDireccion, Long cliId,
        String cliMail, String cliNombre, String cliTelefono, Long tdocCodigo)
        throws Exception {
        try {
            ...
            entity.setTdocCodigo(FacesUtils.checkLong(tdocCodigo));
            businessDelegatorView.updateClientes(entity);
            FacesUtils.addInfoMessage(ZMessManager.ENTITY_SUCCESFULLYMODIFIED);
        } catch (Exception e) {
