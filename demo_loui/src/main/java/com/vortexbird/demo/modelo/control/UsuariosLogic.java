...
public class UsuariosLogic implements IUsuariosLogic {
    ...
    public void deleteUsuarios(Usuarios entity) throws Exception {
        ...
        if (entity.getUsuCedula() == null) {
            throw new ZMessManager().new EmptyFieldException("usuCedula");
        }
    ...
    public List<UsuariosDTO> getDataUsuarios() throws Exception {
        try {
            ...
            for (Usuarios usuariosTmp : usuarios) {
                UsuariosDTO usuariosDTO2 = usuariosMapper.usuariosToUsuariosDTO(usuariosTmp);
    ...
    public Usuarios getUsuarios(Long usuCedula) throws Exception {
        ...
        try {
            entity = usuariosDAO.findById(usuCedula);
        } catch (Exception e) {
